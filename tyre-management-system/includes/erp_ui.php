...
function erp_ui_extra_stylesheets(): array
{
    ...
    $map = [
        ...
        'super/dashboard' => ['admin-control-center.css'],
        'admin/dashboard' => ['admin-control-center.css'],
        'admin/users' => ['admin-control-center.css'],
        'admin/roles' => ['admin-control-center.css'],
        'admin/departments' => ['admin-control-center.css'],
        'admin/settings' => ['admin-control-center.css'],
        'admin/activity-logs' => ['admin-control-center.css'],
        'admin/reports' => ['admin-control-center.css'],
        'admin/system-health' => ['admin-control-center.css'],
        'admin/user' => ['admin-control-center.css'],
        'admin/backup' => ['admin-control-center.css'],
        'admin/employee-oversight' => ['admin-control-center.css'],
        'admin/sales-oversight' => ['admin-control-center.css'],
        'admin/purchase-oversight' => ['admin-control-center.css'],
        'admin/finance-oversight' => ['admin-control-center.css'],
        'accounts/payments' => ['sales-module.css', 'accounts-transactions.css'],
        'accounts/reports' => ['sales-module.css', 'accounts-reports.css'],
