...
function erp_ui_extra_stylesheets(): array
{
    ...
    $map = [
        ...
        'super/dashboard' => ['admin-console.css'],
        'admin/dashboard' => ['admin-console.css'],
        'admin/users' => ['admin-console.css', 'admin-users.css'],
        'admin/roles' => ['admin-console.css'],
        'admin/departments' => ['admin-console.css'],
        'admin/settings' => ['admin-console.css'],
        'admin/company-config' => ['admin-console.css'],
        'admin/activity-logs' => ['admin-console.css'],
        'admin/business-overview' => ['admin-console.css'],
        'admin/monitoring' => ['admin-console.css'],
        'admin/reports' => ['admin-console.css'],
        'admin/system-health' => ['admin-console.css'],
        'admin/user' => ['admin-console.css', 'admin-users.css', 'admin-user-profile.css'],
        'admin/security-center' => ['admin-console.css'],
        'admin/company-settings' => ['admin-console.css'],
        'admin/backup' => ['admin-console.css'],
