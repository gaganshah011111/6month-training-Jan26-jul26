...
function page_allowed_roles(): array
{
    return [
        ...
        'sales/invoices' => ['Sales Manager'],
        'sales/invoice' => ['Sales Manager'],
        'sales/invoice-print' => ['Sales Manager'],
        'sales/payment-receipt' => ['Sales Manager'],
        'sales/order-print' => ['Sales Manager'],
        'sales/payments' => ['Sales Manager'],
        'sales/dispatch' => ['Sales Manager'],
        'sales/reports' => ['Sales Manager'],
        'sales/analytics' => ['Sales Manager'],
        'accounts/dashboard' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/ledger' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/receivables' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/payables' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/expenses' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/cashbook' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/bankbook' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/gst' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/pnl' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/balance-sheet' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/payments' => ['Super Admin', 'Admin', 'Sales Manager'],
        'accounts/reports' => ['Super Admin', 'Admin', 'Sales Manager'],
