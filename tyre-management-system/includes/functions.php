...
function normalize_role_name(string $role): string
{
    ...
    return match ($normalized) {
        ...
        'sales manager', 'sales_manager', 'salesmanager' => 'Sales Manager',
        'accounts manager', 'accounts_manager', 'accountsmanager' => 'Accounts Manager',
...
function role_home_file(string $role): string
{
    ...
    return match ($role) {
        ...
        'Sales Manager' => 'sales_dashboard.php',
        'Accounts Manager' => 'accounts_dashboard.php',
...
function page_allowed_roles(): array
{
    return [
        ...
        'api/admin-user-preview' => ['Super Admin', 'Admin'],
        'admin/system-health' => ['Super Admin', 'Admin'],
        'admin/business-overview' => ['Super Admin', 'Admin'],
        'admin/monitoring' => ['Super Admin', 'Admin'],
        'admin/security-center' => ['Super Admin', 'Admin'],
        'admin/company-settings' => ['Super Admin', 'Admin'],
        'admin/company-config' => ['Super Admin', 'Admin'],
        'admin/reports' => ['Super Admin', 'Admin'],
        ...
        'inventory/purchase-history' => ['Inventory Manager', 'Super Admin', 'Admin', 'Accounts Manager'],
        'inventory/purchase-print' => ['Inventory Manager', 'Super Admin', 'Admin', 'Accounts Manager'],
        'inventory/purchase-edit' => ['Inventory Manager', 'Super Admin', 'Admin'],
        'inventory/purchase-payments' => ['Inventory Manager', 'Super Admin', 'Admin', 'Accounts Manager'],
        'inventory/supplier-ledger' => ['Inventory Manager', 'Super Admin', 'Admin', 'Accounts Manager'],
        ...
        'dispatch/history' => ['Dispatch Manager', 'Super Admin', 'Admin', 'Sales Manager'],
        'dispatch/list' => ['Dispatch Manager', 'Super Admin', 'Admin', 'Sales Manager'],
        'dispatch/dashboard' => ['Dispatch Manager', 'Super Admin', 'Admin', 'Sales Manager'],
        ...
        'sales/dashboard' => ['Sales Manager'],
        'sales/customers' => ['Sales Manager'],
        'sales/customer' => ['Sales Manager'],
        'sales/orders' => ['Sales Manager'],
        'sales/order' => ['Sales Manager'],
        'sales/invoices' => ['Sales Manager', 'Accounts Manager'],
        'sales/invoice' => ['Sales Manager', 'Accounts Manager'],
        'sales/invoice-print' => ['Sales Manager', 'Accounts Manager'],
        'sales/payment-receipt' => ['Sales Manager', 'Accounts Manager'],
        'sales/order-print' => ['Sales Manager'],
        'sales/payments' => ['Sales Manager', 'Accounts Manager'],
        'sales/dispatch' => ['Sales Manager'],
        ...
        'accounts/payments' => ['Super Admin', 'Admin', 'Sales Manager', 'Accounts Manager'],
        'accounts/payment-receipt' => ['Super Admin', 'Admin', 'Sales Manager', 'Accounts Manager'],
        'accounts/transactions-history' => ['Super Admin', 'Admin', 'Sales Manager', 'Accounts Manager'],
        'accounts/reports' => ['Super Admin', 'Admin', 'Sales Manager', 'Accounts Manager'],
        'api/sales-stock' => ['Sales Manager'],
        'api/sales-order-lines' => ['Sales Manager'],
        'api/sales-dispatch-prefill' => ['Dispatch Manager', 'Super Admin', 'Sales Manager'],
        'api/accounts-receivable-payment' => ['Accounts Manager', 'Super Admin', 'Admin', 'Sales Manager'],
        'api/accounts-payable-payment' => ['Accounts Manager', 'Super Admin', 'Admin', 'Sales Manager'],

        'api/dispatch-save' => ['Dispatch Manager', 'Sales Manager'],
        'api/dispatch-stock' => ['Dispatch Manager', 'Sales Manager'],
        'api/dispatch-preview' => ['Dispatch Manager', 'Sales Manager'],
        'dispatch/slip' => ['Dispatch Manager', 'Sales Manager'],
        ...
        'employee/change-password' => ['Employee', 'Super Admin', 'Admin', 'HR Manager', 'Production Manager', 'Inventory Manager', 'Dispatch Manager', 'Quality Manager', 'Accounts Manager'],
