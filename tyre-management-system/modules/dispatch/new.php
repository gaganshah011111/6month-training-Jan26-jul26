...
<div class="dsp-entry-page dsp-page--entry">
    <header class="dsp-entry-header">
        <div class="dsp-entry-header__text">
            <h1 class="dsp-entry-header__title">New Dispatch Entry</h1>
            <p class="dsp-entry-header__sub">Record outbound shipment — stock validates live as you type</p>
        </div>
        <nav class="dsp-entry-header__actions">
            <a href="<?= e(route_url('dispatch/logistics')) ?>" class="dsp-entry-btn-outline">Logistics</a>
    ...
    <?php if ($logisticsEmpty): ?>
        <div class="dsp-entry-alert dsp-entry-alert--warn">
            ...
            Set up <a href="<?= e(route_url('dispatch/logistics')) ?>">Logistics</a> (drivers &amp; vehicles) before creating a dispatch.
        </div>
    <?php endif; ?>
