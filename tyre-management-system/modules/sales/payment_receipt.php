...
$collector = (string)(current_user()['name'] ?? current_user()['username'] ?? 'Sales');
...
erp_doc_print_header($company, 'Payment Receipt', 'Official payment acknowledgement', 'Sales & CRM · Collections');
